...
export const Contact: React.FC<ContactProps> = ({ darkMode, requestedSubject, requestedMessage, openEmailRedirect }) => {
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className={`p-6 rounded-3xl border transition-all ${
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <button 
                    ...
                    className="font-bold text-sm sm:text-base text-slate-200 hover:text-cyan-400 transition-colors text-left"
                    title="Click to redirect to your email application"
                  >
                    {personalInfo.email}
                  </button>
                </div>
            ...
            <div className="pt-3 border-t border-slate-800/40 flex items-center justify-between">
              <span className="text-xs text-slate-400">Preferred channel for interviews and job offers.</span>
              <button
                type="button"
                id="contact-launch-email-app-btn"
                onClick={() => openEmailRedirect ? openEmailRedirect() : (window.location.href = `mailto:${personalInfo.email}`)}
                className="inline-flex items-center gap-1 text-xs font-semibold text-cyan-400 hover:text-cyan-300 transition-colors group"
                title="Launch in default machine email app"
              >
          ...
          <div className={`p-6 rounded-3xl border ${
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                type="button"
                id="contact-network-email-btn"
                onClick={() => openEmailRedirect ? openEmailRedirect() : (window.location.href = `mailto:${personalInfo.email}`)}
                className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold bg-cyan-600/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-600/30 transition-colors"
                title="Open email app with receiver gurung.sg79@gmail.com"
              >
